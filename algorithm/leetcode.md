...
> **⚠ 整理中**
> 
> 手动整理太慢，简单写了一份代码，有需要可以根据你的需求改一改就好了
> 
> ```js
...
| 300  | 中等 | [最长上升子序列](https://leetcode-cn.com/problems/longest-increasing-subsequence)                            | 动态规划<br>贪心 二分法 | 后面的dp从前面符合条件的dp取最大<br>维护一个序列：大的接在后面，小的找个位置挤掉一个相对大的 |
| 322  | 中等 | [零钱兑换](https://leetcode-cn.com/problems/coin-change)                                                     |                         |                                                                                              |
| 357  | 中等 | [计算各个位数不同的数字个数](https://leetcode-cn.com/problems/count-numbers-with-unique-digits)              |                         |                                                                                              |
| 365  | 中等 | [水壶问题](https://leetcode-cn.com/problems/water-and-jug-problem)                                           |                         |                                                                                              |
| 404  | 简单 | [左叶子之和](https://leetcode-cn.com/problems/sum-of-left-leaves/)                                           | 树                      | 给函数增加一个“当前节点是否为左节点”的标记                                                   |
| 409  | 简单 | [最长回文串](https://leetcode-cn.com/problems/longest-palindrome)                                            |                         |                                                                                              |
...
| 543  | 简单 | [二叉树的直径](https://leetcode-cn.com/problems/diameter-of-binary-tree)                                |            |                                                      |
